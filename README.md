...
| Project Name | Domain | Description |
| :--- | :--- | :--- |
| **[ ChurnGuard (High Tier)](DS_01_ChurnGuard_Retention_AI.ipynb)** | **Banking / CRM** | **(Must See!)** Predicting customer churn using **XGBoost** and interpreting reasons with **SHAP (Explainable AI)**. Deployed with Gradio. |
