"""
Project: VisionQuery - Multimodal Visual Q&A
Role: AI Engineer
Description: Aplikasi AI cerdas yang menggabungkan Computer Vision dan NLP (ViLT) untuk menjawab pertanyaan berdasarkan gambar.

Library yang dibutuhkan (requirements.txt):
- transformers
- torch
- pillow
"""
